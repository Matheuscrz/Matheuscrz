...
- 👀 Desenvolvedor backend, sempre buscando aprimorar minhas habilidades.
- 💼 Atualmente trabalho como desenvolvedor backend na Sergipetec, atuando no desenvolvimento e manutenção de sistemas de monitoramento e gestão.
- 🧠 Especialista em backend, com experiência em Java (Spring), bancos de dados relacionais (PostgreSQL) e não relacionais, mensageria, monitoramento e automação de infraestrutura.
- 🚀 Interesse em arquitetura de sistemas, microsserviços, automação, DevOps e boas práticas de desenvolvimento.
- 👯‍♂️ Busco colaborar em projetos inovadores e iniciativas open-source.
- 💬 Me pergunte sobre desenvolvimento backend, bancos de dados, automação, mensageria, monitoramento ou arquitetura de sistemas.
